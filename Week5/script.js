...
//Practice Question 1
//starting with Cap means its a constructor function
...
let people = [];
//also takes anme and age but trying not to confuse
...
function Car(mk,md,yr){
  ...
  this.getCarInfo = function() {
    return `This make is ${this.make}. The model is ${this.model} and the year is ${this.year}.`;
  };
}

let car1 = new Car("Volvo", "EX", 2021);
